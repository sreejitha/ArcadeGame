...
var Engine = (function(global) {
  ...
  /* This function checks for collisions between each of the enemies and the
   * player
   */
  ...
  /* This function checks if  the player managed to reach the water layer
   * If yes, then game-over modal is displayed
   */
  ...
  function constructHiddenGameOverModal() {
    ...
    modalTextpara.textContent = 'Yohooo!!! You made it to the water!'
